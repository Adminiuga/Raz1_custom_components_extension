...
// <adc> SL_BATTERY_MONITOR_ADC
// $[ADC_SL_BATTERY_MONITOR_ADC]
#ifndef SL_BATTERY_MONITOR_ADC_PERIPHERAL       
#define SL_BATTERY_MONITOR_ADC_PERIPHERAL        ADC0
#endif
#ifndef SL_BATTERY_MONITOR_ADC_PERIPHERAL_NO    
#define SL_BATTERY_MONITOR_ADC_PERIPHERAL_NO     0
#endif
#define SL_BATTERY_MONITOR_ADC_POS               adcPosSelAPORT3XCH14
#define SL_BATTERY_MONITOR_ADC_NEG               adcNegSelVSS
// [ADC_SL_BATTERY_MONITOR_ADC]$
// <<< sl:end pin_tool >>>
