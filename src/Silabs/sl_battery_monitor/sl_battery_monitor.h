...
/** @brief Get the battery voltage in milli volts
 *
 * This function will perform whatever hardware interaction is necessary to
 * get the battery voltage and return it in millivolts.
 *
 * @return The battery_voltage in millivolts
 */
 ...
 */
void sl_battery_monitor_measurement_ready_cb(uint16_t batteryVoltageMilliV);
